...
pid32	currpid, currentpid;		/* ID of currently executing process	*/
...
{	
	...
	resume(create((void *)startup, INITSTK, INITGROUP, INITPRIO,
...
local process	startup(void)
{
	...
	resume(create((void *)main, INITSTK, INITGROUP, INITPRIO,
					"Main process", 0, NULL));
