...
extern void aging(pid32);

/* in file bufinit.c */
extern	status	bufinit(void);

/* in file chprio.c */
extern	pri32	chprio(pid32, pri32);

extern void chgprio(int , pri32);

extern void proportionalshare(void);

extern void tssched(void);
...
/* in file create.c */
extern	pid32	create(void *, uint32, int ,pri32 , char *, uint32, ...);
